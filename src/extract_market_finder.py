...
Usage:
    python src/extract_market_finder.py --state "Texas" --county "Travis"
    python src/extract_market_finder.py --state "Texas" --county "Travis" --headless
    python src/extract_market_finder.py --state "Texas" --county "Travis,Bell,Williamson"
...
def main():
    ...
    parser.add_argument(
        "--state", required=True, help="State name (e.g., Texas)"
    )
    parser.add_argument(
        "--county",
        required=True,
        help="County name(s), comma-separated (e.g., Travis or Travis,Bell,Williamson)",
    )
    parser.add_argument(
        "--headless",
        action="store_true",
